...
{    
    ...
    //DMA_count_Init(DMA_CH14, PTB18 , 0x7FFF, DMA_rising);//B18  dma初始化编码器用
    
//    gpio_init (PTA13, GPI,1);//编码器方向
//    gpio_init (PTB19, GPI,1);//编码器方向
 ...
 /* PWM */
     ...
     ftm_pwm_init(FTM0, FTM_CH3,10000, 0);   //电机初始化
     
     ftm_pwm_init(FTM0, FTM_CH2,10000, 0);    //电机初始化
     
     ftm_pwm_init(FTM1, FTM_CH1,200, 2250);     //舵机初始化
     
     gpio_init (PTC2, GPO,1);//电机使能
//     FT_PWM_QuickInit(FTM0_CH3_PC04,kPWM_EdgeAligned,10000);    //电机
//     FTM_PWM_QuickInit(FTM0_CH2_PC03,kPWM_EdgeAligned,10000);    //电机
//     FT_PWM_QuickInit(FTM1_CH1_PA09,kPWM_EdgeAligned,200);      //舵机
//     FTM_PWM_ChangeDuty(HW_FTM0, HW_FTM_CH3, 0);
//     FTM_PWM_ChangeDuty(HW_FTM0, HW_FTM_CH2, 0);
//     FTM_PWM_ChangeDuty(HW_FTM1, HW_FTM_CH1, 2250);
     
     KEY_init();
     
//     ftm_pwm_duty(FTM1, FTM_CH1,600);
//     
//     while(1)
//     {
//     
