///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.2.13589/W32 for ARM      11/Jun/2017  21:36:20
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Drivers\Control\Control.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EW959D.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Drivers\Control\Control.c -D DEBUG -D
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\Control.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Drivers\Control\Control.c
...
//  184 register  float  SpeedError=0,Speed_temp=0,SpeedFilterRatio=0.85;
        MOVS     R6,#+0
        MOVS     R7,#+0
        LDR.W    R5,??DataTable24_12  ;; 0x3f59999a
...
//  361   else
//  362   {
//  363       ftm_pwm_duty(FTM0, FTM_CH3,0);
??Set_Moto_0:
        MOVS     R2,#+0
        MOVS     R1,#+3
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  364       ftm_pwm_duty(FTM0, FTM_CH2,A);
        MOVS     R2,R4
        MOVS     R1,#+2
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
Duoji_Out:
        PUSH     {R4,LR}
          ...
          CFI CFA R13+8
        MOVS     R4,R0
//  370   //FTM_PWM_ChangeDuty(HW_FTM1, HW_FTM_CH1, (4200+resultturn));    //    A车4200   resultturn -650  650   B车3500   +800  -600
//  371 
//  372   A=A>600?600:A<-600?-600:A;
        MOVW     R0,#+601
        CMP      R4,R0
        BLT.N    ??Duoji_Out_0
        MOV      R4,#+600
...
??Duoji_Out_0:
        ...
        B.N      ??Duoji_Out_1
//  373   
//  374   ftm_pwm_duty(FTM1, FTM_CH1,2500+A);
??Duoji_Out_2:
??Duoji_Out_1:
        ADDW     R2,R4,#+2500
        MOVS     R1,#+1
...
//  378 /*************电机输出****************/
        ...
        THUMB
//  379 __ramfunc void Moto_Out(void)
//  380 {
Moto_Out:
        PUSH     {R4,LR}
          CFI R14 Frame(CFA, -4)
          CFI R4 Frame(CFA, -8)
          CFI CFA R13+8
//  381   register float sum=0;
        MOVS     R4,#+0
//  382     
//  383   //速度控制输出限幅
//  384 //  if(PID_SPEED.OUT>PID_ANGLE.P*Forward_Safe_Angle)//如果车子前倾，则车模的速度控制输出为正，反之为负
//  385 //  PID_SPEED.OUT=PID_ANGLE.P*Forward_Safe_Angle;                       //已经倾斜到到安全角度了
//  386 //  if(PID_SPEED.OUT<-PID_ANGLE.P*Backward_Safe_Angle)
//  387 //  PID_SPEED.OUT=-PID_ANGLE.P*Backward_Safe_Angle;
//  388   
//  389 //  if(PID_TURN.P==0)
//  390 //  PID_TURN.OUT=0;
//  391 //  if(PID_ANGLE.P==0)
//  392 //  PID_ANGLE.OUT=0;
//  393 //    
//  394 //  PID_SPEED.OUT=PID_SPEED.OUT>1000?1000:PID_SPEED.OUT<-1000?-1000:PID_SPEED.OUT;
//  395     
//  396 //  sum=PID_SPEED.OUT;//PID_ANGLE.OUT+
//  397 //  LeftMotorOut=sum+PID_TURN.OUT;   //计算输出值
//  398 //  RightMotorOut=sum-PID_TURN.OUT;  
//  399   
//  400   MotoOut=PID_SPEED.OUT;
        LDR.N    R0,??DataTable24_4
        LDR      R0,[R0, #+24]
          CFI FunCall __aeabi_f2iz
        BL       __aeabi_f2iz
        LDR.N    R1,??DataTable24_42
        STR      R0,[R1, #+0]
//  401   
//  402   
//  403   Set_Moto((int)MotoOut);
        LDR.N    R0,??DataTable24_42
        LDR      R0,[R0, #+0]
          CFI FunCall Set_Moto
        BL       Set_Moto
//  404   Duoji_Out((int)PID_TURN.OUT);
        LDR.N    R0,??DataTable24_35
        LDR      R0,[R0, #+24]
          CFI FunCall __aeabi_f2iz
        BL       __aeabi_f2iz
        ...
        BL       Duoji_Out
//  405   
//  406   //Set_Pwm(LeftMotorOut,RightMotorOut);
//  407 return ;
        POP      {R4,PC}          ;; return
//  408 }
...
//  409 
        ...
        SECTION `.bss`:DATA:REORDER:NOROOT(2)
        DATA
//  410 int OLD_PWM_LEFT=0,OLD_PWM_RIGHT=0;
OLD_PWM_LEFT:
        DS8 4
...
//  411 
        ...
        THUMB
//  412 void Set_Pwm(int Left,int Right)
//  413 {
Set_Pwm:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
        ...
        MOVS     R4,R0
        MOVS     R5,R1
//  414   Left=Left>=990?990:Left<=-990?-990:Left;
        MOVW     R0,#+990
        CMP      R4,R0
        BLT.N    ??Set_Pwm_0
        MOVW     R4,#+990
...
??Set_Pwm_0:
        ...
        B.N      ??Set_Pwm_1
//  415   Right=Right>=990?990:Right<=-990?-990:Right;
??Set_Pwm_2:
??Set_Pwm_1:
        MOVW     R0,#+990
        CMP      R5,R0
...
??Set_Pwm_4:
        ...
        BNE.N    ??Set_Pwm_6
//  418 {
//  419     ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  420     ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  421     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  422     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  428   if (Left<0)
        ...
        BPL.N    ??Set_Pwm_9
//  429   {
//  430   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  431   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  432   ftm_pwm_duty(    FTM0, FTM_CH4, -Left+30 );
        RSBS     R2,R4,#+30
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  433   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  435   else 
//  436   {
//  437   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
??Set_Pwm_9:
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  438   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  439   ftm_pwm_duty(    FTM0, FTM_CH5, Left+30 );
        ADDS     R2,R4,#+30
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  440   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  441   }
//  442   
//  443   OLD_PWM_LEFT=Left;
??Set_Pwm_10:
        LDR.N    R0,??DataTable5_10
        STR      R4,[R0, #+0]
//  444 }
//  445 
//  446 if(OLD_PWM_RIGHT!=Right)
??Set_Pwm_8:
...
//  448   if(Right>=0)
        ...
        BMI.N    ??Set_Pwm_12
//  449   {
//  450     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  451     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  452     ftm_pwm_duty(    FTM0, FTM_CH6, Right+30 );
        ADDS     R2,R5,#+30
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  453     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  455   else 
//  456   {
//  457     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
??Set_Pwm_12:
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  458     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  459     ftm_pwm_duty(    FTM0, FTM_CH7, -Right+30 );
        RSBS     R2,R5,#+30
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  460     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  467 
        ...
        THUMB
//  468 void SSet_Pwm(int Left,int Right)
//  469 {
SSet_Pwm:
        PUSH     {R3-R5,LR}
          CFI R14 Frame(CFA, -4)
...
//  470  if(Right>=0)
        ...
        BMI.N    ??SSet_Pwm_0
//  471   {
//  472     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  473     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  474     ftm_pwm_duty(    FTM0, FTM_CH6, Right+30 );
        ADDS     R2,R5,#+30
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  475     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  477   else 
//  478   {
//  479     ftm_pwm_duty(    FTM0, FTM_CH7, 0 );
??SSet_Pwm_0:
        MOVS     R2,#+0
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  480     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  481     ftm_pwm_duty(    FTM0, FTM_CH7, -Right+30 );
        RSBS     R2,R5,#+30
        MOVS     R1,#+7
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  482     ftm_pwm_duty(    FTM0, FTM_CH6, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+6
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
??SSet_Pwm_1:
        ...
        BPL.N    ??SSet_Pwm_2
//  486   {
//  487   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  488   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  489   ftm_pwm_duty(    FTM0, FTM_CH4, -Left+50 );
        RSBS     R2,R4,#+50
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  490   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
...
//  492   else 
//  493   {
//  494   ftm_pwm_duty(    FTM0, FTM_CH5, 0 );
??SSet_Pwm_2:
        MOVS     R2,#+0
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  495   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  496   ftm_pwm_duty(    FTM0, FTM_CH5, Left+50 );
        ADDS     R2,R4,#+50
        MOVS     R1,#+5
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
        BL       ftm_pwm_duty
//  497   ftm_pwm_duty(    FTM0, FTM_CH4, 0 );
        MOVS     R2,#+0
        MOVS     R1,#+4
        MOVS     R0,#+0
          CFI FunCall ftm_pwm_duty
