...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Drivers\ZLG_GUI\FONT8_8.C
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EW9A06.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Drivers\ZLG_GUI\FONT8_8.C -D DEBUG -D
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\FONT8_8.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        END
// C:\Users\WJL-PC\Desktop\Car\Drivers\ZLG_GUI\FONT8_8.C
//    1 /****************************************************************************************
//    2 * 文件名：FONT8_8.C
...
// 1084 
// 1085    /* 参数过滤 */
// 1086    if( x>(GUI_LCM_XMAX-8) ) return(0);
// 1087    if( y>(GUI_LCM_YMAX-8) ) return(0);
// 1088    if( (ch<0x20) || (ch>0x7f) ) ch = 0x20;
// 1089    
// 1090    ch -= 0x20; 
// 1091    for(i=0; i<8; i++)
// 1092    {  /* 读取点阵数据 */
// 1093       font_dat = FONT8x8ASCII[ch][i];
// 1094       
// 1095       for(j=0; j<8; j++)
// 1096       {  /* 设置相应的点为color或为back_color */
// 1097          if( (font_dat&DCB2HEX_TAB[j])==0 ) GUI_CopyColor(&bakc, back_color);
// 1098             else  GUI_CopyColor(&bakc, disp_color);
// 1099          GUI_Point(x, y, bakc);       
// 1100          x++;
// 1101       }
// 1102       
// 1103       y++;									// 指向下一行
...
// 1122 {  while(1)
// 1123    {  if( (*str)=='\0' ) break;
// 1124       if( GUI_PutChar8_8(x, y, *str++)==0 ) break;
// 1125       x += 6;								// 下一个字符显示位置，y不变(即不换行)
// 1126    }
// 1127 }
// 1128 
// 1129 
