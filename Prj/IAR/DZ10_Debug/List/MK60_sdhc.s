...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Chip\src\MK60_sdhc.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EWB1D4.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Chip\src\MK60_sdhc.c -D DEBUG -D
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\MK60_sdhc.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Chip\src\MK60_sdhc.c
//    1 /*!
//    2  *     COPYRIGHT NOTICE
...
SDHC_card:
        ...
        DATA
?_0:
        DC8 "C:\\Users\\WJL-PC\\Desktop\\Car\\Chip\\src\\MK60_sdhc.c"
        DC8 0, 0, 0
//   24 
//   25 
//   26 //SD卡命令
...
??SDHC_cmd_7:
        LDR.W    R1,??DataTable3_17  ;; 0xffff0200
        B.N      ??SDHC_cmd_8
//  287         }
//  288     }
//  289     else
...
//  298     SDHC_DSADDR = 0;
        MOVS     R0,#+0
        LDR.W    R2,??DataTable3_18  ;; 0x400b1000
        STR      R0,[R2, #+0]
...
??SDHC_cmd_9:
        LDR.W    R0,??DataTable3_10  ;; 0x400b1030
        LDR      R0,[R0, #+0]
        LDR.W    R2,??DataTable3_20  ;; 0xe0001
        TST      R0,R2
        BEQ.N    ??SDHC_cmd_9
...
//  305         SDHC_IRQSTAT |= SDHC_IRQSTAT_CTOE_MASK | SDHC_IRQSTAT_CIE_MASK | SDHC_IRQSTAT_CEBE_MASK | SDHC_IRQSTAT_CCE_MASK | SDHC_IRQSTAT_CC_MASK;
        ...
        ORR      R0,R0,#0xF0000
        ORRS     R0,R0,#0x1
        LDR.W    R2,??DataTable3_10  ;; 0x400b1030
        STR      R0,[R2, #+0]
