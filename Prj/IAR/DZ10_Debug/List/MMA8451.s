///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.2.13589/W32 for ARM      11/Jun/2017  21:36:28
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Drivers\IIC_Angle\MMA8451.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EWB498.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Drivers\IIC_Angle\MMA8451.c -D DEBUG -D
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\MMA8451.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Drivers\IIC_Angle\MMA8451.c
//    1 #include "common.h"
...
//   42 	gyro0=(int)(1.978*(-gyro0-26));//让角速度静止初值为0  并让角速度值与角度值关联            //2.4
        ...
        BL       __aeabi_i2d
        LDR.N    R2,??MMA8451_ITG3200_function1_0  ;; 0x53f7ced9
        LDR.N    R3,??MMA8451_ITG3200_function1_0+0x4  ;; 0x3fffa5e3
...
//   47 	OUT0=OUT0-(gyro1*0.005);//0.005
        ...
        MOV      R0,R8
          CFI FunCall __aeabi_f2d
        BL       __aeabi_f2d
        LDR.N    R2,??MMA8451_ITG3200_function1_0+0xC  ;; 0x47ae147b
        LDR.N    R3,??MMA8451_ITG3200_function1_0+0x10  ;; 0x3f747ae1
          CFI FunCall __aeabi_dmul
        BL       __aeabi_dmul
        MOVS     R2,R0
        MOVS     R3,R1
