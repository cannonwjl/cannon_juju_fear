...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Lib\USB\USB.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EWBC42.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Lib\USB\USB.c -D DEBUG -D ARM_MATH_CM4
...
//    Locale       =  C
//    List file    =  C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\USB.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Lib\USB\USB.c
//    1 #include "USB.h"
...
Device_Descriptor:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
// __absolute uint8 const String_Descriptor0[4]
String_Descriptor0:
        DC8 4, 3, 9, 4

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
// __absolute uint8 const String_Descriptor1[18]
String_Descriptor1:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
// __absolute uint8 const String_Descriptor2[18]
String_Descriptor2:
        DC8 18, 3, 85, 0, 83, 0, 66, 0, 45, 0, 85, 0, 65, 0, 82, 0, 84, 0, 0, 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
// __absolute uint8 const String_Descriptor3[18]
String_Descriptor3:
        DC8 18, 3, 84, 0, 69, 0, 83, 0, 84, 0, 95, 0, 49, 0, 46, 0, 49, 0, 0, 0

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        DATA
// __absolute uint8 const Configuration_Descriptor[67]
