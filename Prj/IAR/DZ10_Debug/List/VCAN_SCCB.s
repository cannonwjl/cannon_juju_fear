///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.2.13589/W32 for ARM      11/Jun/2017  21:36:31
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Board\src\VCAN_SCCB.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EWC189.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Board\src\VCAN_SCCB.c -D DEBUG -D
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\VCAN_SCCB.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Board\src\VCAN_SCCB.c
//    1 /*!
//    2  *     COPYRIGHT NOTICE
...
//   58     SDA_H();
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7  ;; 0x43fe1010
        STR      R0,[R1, #+0]
//   59     SCL_H();
        MOVS     R0,#+1
...
//   62     SDA_DDR_IN();
        MOVS     R0,#+0
        LDR.N    R1,??DataTable7_2  ;; 0x43fe1290
        STR      R0,[R1, #+0]
//   63     if(!SDA_IN())
        LDR.N    R0,??DataTable7_3  ;; 0x43fe1210
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BNE.N    ??SCCB_Start_0
//   64     {
