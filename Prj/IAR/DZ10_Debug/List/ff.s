///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.2.13589/W32 for ARM      11/Jun/2017  21:36:21
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\Lib\FatFs\ff.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EW987D.tmp
//        (C:\Users\WJL-PC\Desktop\Car\Lib\FatFs\ff.c -D DEBUG -D ARM_MATH_CM4
...
//    Locale       =  C
//    List file    =  C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\ff.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\WJL-PC\Desktop\Car\Lib\FatFs\ff.c
//    1 /*----------------------------------------------------------------------------/
...
??put_fat_8:
        LSLS     R0,R9,#+23       ;; ZeroExtS R0,R9,#+23,#+23
        LSRS     R0,R0,#+23
        ADD      R0,R5,R0
        ADDS     R0,R0,#+48
        MOV      R8,R0
...
// 2080         fno->fsize = LD_DWORD(dir + DIR_FileSize);  /* Size */
        ...
        LDRB     R12,[R4, #+30]
        LSLS     R12,R12,#+16
        ORRS     R12,R12,R2, LSL #+24
        LDRB     R2,[R4, #+29]
        ORRS     R12,R12,R2, LSL #+8
        LDRB     R2,[R4, #+28]
        ORRS     R12,R2,R12
        STR      R12,[R1, #+0]
...
// 9 534 bytes in section .text
// 
// 9 534 bytes of CODE  memory
