///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.11.2.13589/W32 for ARM      13/Jun/2017  08:54:47
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\WJL-PC\Desktop\Car\App\main.c
//    Command line =  
//        -f C:\Users\WJL-PC\AppData\Local\Temp\EW1446.tmp
//        (C:\Users\WJL-PC\Desktop\Car\App\main.c -D DEBUG -D ARM_MATH_CM4 -D
//        MK60DZ10 -lA C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List -o
...
//    Locale       =  C
//    List file    =  
//        C:\Users\WJL-PC\Desktop\Car\Prj\IAR\DZ10_Debug\List\main.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        EXTERN gpio_set
        EXTERN gpio_turn
        EXTERN ov7725_eagle_dma
        EXTERN ov7725_eagle_vsync
        EXTERN sprintf
        EXTERN uart_putbuff
        EXTERN uart_putchar
...
// C:\Users\WJL-PC\Desktop\Car\App\main.c
//    1 /**************************************************************************************
//    2 * @author     山外科技
//    3 * @version    v5.0
//    4 * @date       2013-08-28
...
main:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  160 //   ftm_pwm_init(FTM0, FTM_CH3,10000, 200);   
//  161 //   ftm_pwm_init(FTM0, FTM_CH2,10000, 0); 
//  162 ////    gpio_init (PTC3, GPO,1);//电机使能
//  163 ////    gpio_init (PTC4, GPO,0);//电机使能
//  164 ////    
//  165 //    //ftm_pwm_init(FTM0, FTM_CH1,10000, 0);   
//  166 //  //gpio_init (PTC2, GPO,1);//电机使能
//  167 //    
//  168 //    //ftm_pwm_duty(FTM0, FTM_CH1,500);
//  169 //    while(1)
//  170 //    {
//  171 //    
//  172 //    //MOTO_ON;
...
//  174   
//  175   
//  176    All_Init(0);  //传入参数匹配不同方案(暂时无用)	
        MOVS     R0,#+0
          CFI FunCall All_Init
        BL       All_Init
//  177   // Beep(100);
//  178   // Car_Protect();//车体保护
//  179    
//  180   return 0;
        MOVS     R0,#+0
        POP      {R1,PC}          ;; return
...
??Dr_6_0:
        ...
        B.N      ??Dr_6_11
//  189         {
//  190         	case 0:		CASE = Case_UI(); break;	//主菜单
??Dr_6_1:
          CFI FunCall Case_UI
        BL       Case_UI
        ...
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  191         	case 1:		CASE = View();    break;	//参数预览菜单   》内分6个紫菜单
??Dr_6_3:
          CFI FunCall View
        BL       View
        LDR.N    R1,??DataTable18_5
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  192                 case 2:         CASE = Plan_Choose();break; //方案选择       》6方案选择
??Dr_6_2:
        ...
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  193         	case 3:		CASE = Set();     break;	//参数设置
??Dr_6_5:
          CFI FunCall Set
        BL       Set
        LDR.N    R1,??DataTable18_5
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  194                 case 4:         CASE = Debug_Button();break;//调试开关
??Dr_6_4:
...
//  196             
//  197             //以下是左右按键调出的菜单
//  198         	case 5:		CASE = Car_Ctrl();break;	//发车
??Dr_6_7:
        ...
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  199         	case 6:		CASE = Updata();  break;	//升级界面
??Dr_6_6:
          CFI FunCall Updata
        BL       Updata
        LDR.N    R1,??DataTable18_5
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  200         	case 7:		CASE = Set_Ang(); break;	//调整中值
??Dr_6_9:
          CFI FunCall Set_Ang
        BL       Set_Ang
        LDR.N    R1,??DataTable18_5
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  201                 case 8:         CASE = View_Set() ;break;   //参数预览界面
??Dr_6_8:
        ...
        STR      R0,[R1, #+0]
        B.N      ??Dr_6_0
//  202                 case 9:         CASE = View_Plan();break;   //方案参数预览界面
??Dr_6_10:
...
//  211 
//  212 /*************************************************************
//  213 *	1ms定时器中断,提供控制流程,严格遵守控制节拍,提供计时变量
//  214 *************************************************************/
        ...
        THUMB
//  215 __ramfunc void PIT0_IRQHandler(void)
//  216 {
PIT0_IRQHandler:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  217  static  uint8  part=0;//状态机节拍
//  218  static  int  Mid_v=0;
//  219  static  int  Last_mid=0;
//  220  
//  221 	if(PIT_TFLG(PIT0) == 1) 
        LDR.N    R0,??DataTable6_4  ;; 0x4003710c
        LDR      R0,[R0, #+0]
        CMP      R0,#+1
        BNE.N    ??PIT0_IRQHandler_0
//  222 	{
//  223 	  	disable_irq(PIT0_IRQn);
        MOVS     R0,#+68
...
//  233 					//速度控制
//  234 					//SpeedCount++;     //计数节拍
//  235 				if(SpeedCount>=10) 
//  236                                 {
//  237                                  Speed_Control();//速度PID计算
//  238                                  SpeedCount=0;
//  239                                  }
//  240                  	 Speed_Control_Output();//速度平滑输出
//  241                          //Angle_Calculate();//角度计算与滤波
//  242 			 //Angle_Control();  //角度PID计算函数
//  243                		break;
//  244 
//  245 			case 2: //赛道类型判断     
//  246 			                 //RodeType_Get();
//  247 
//  248                           AD[0]=adc_once(ADC1_SE4a, ADC_12bit);
//  249                           AD[1]=adc_once(ADC1_SE5a, ADC_12bit);
//  250                           AD[2]=adc_once(ADC1_SE6a, ADC_12bit);
//  251                           AD[3]=adc_once(ADC1_SE7a, ADC_12bit);
//  252                           result=AD[0]-AD[3];
//  253                           
//  254                		break;
//  255 					
//  256 			case 3://赛道中线输出
...
//  262 					DirectionCount=0; //方向平滑输出因子
//  263 					break;
//  264 			case 5:
//  265                                              //DELAY_US(500);
//  266 					part=0;
//  267 					//下面更新陀螺仪转角信息
//  268 					//read_buff[1]= Get_Y_Gyro();
//  269 				       	break;
//  270 			default:
//  271 					part=0;
        MOVS     R0,#+0
...
//  291     
//  292     
//  293 	PIT_Flag_Clear(PIT0);       //清中断标志位
??PIT0_IRQHandler_0:
        LDR.N    R0,??DataTable6_4  ;; 0x4003710c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
        LDR.N    R1,??DataTable6_4  ;; 0x4003710c
        STR      R0,[R1, #+0]
//  294 	enable_irq (PIT0_IRQn);
        MOVS     R0,#+68
...
//  299 *************************************************************/
        ...
        THUMB
//  300 void PIT1_IRQHandler(void)
//  301 {
PIT1_IRQHandler:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  302 	if(PIT_TFLG(PIT1) == 1)
        LDR.N    R0,??DataTable18_6  ;; 0x4003711c
        LDR      R0,[R0, #+0]
        CMP      R0,#+1
        BNE.N    ??PIT1_IRQHandler_0
//  303 	{
//  304 	  disable_irq(PIT1_IRQn);
        MOVS     R0,#+69
          CFI FunCall NVIC_DisableIRQ
        BL       NVIC_DisableIRQ
//  305            GUI_Exec();//刷新屏幕
        ...
        BL       GUI_Exec
//  306 	}
//  307 	PIT_Flag_Clear(PIT1);//清中断标志位
??PIT1_IRQHandler_0:
        LDR.N    R0,??DataTable18_6  ;; 0x4003711c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
...
//  312 *	500ms定时器中断
//  313 *************************************************************/
//  314 //void PIT2_IRQHandler(void)
//  315 //{
//  316 //  //static int iiii=0;
//  317 //	if(PIT_TFLG(PIT2) == 1 )
//  318 //	{
//  319 //		disable_irq(PIT2_IRQn);      
//  320 //	}
//  321 //	
//  322 //	PIT_Flag_Clear(PIT2);//清中断标志位	
//  323 //	enable_irq (PIT2_IRQn);
//  324 //}
//  325 
//  326 /*************************************************************
//  327 *	1s定时器中断
//  328 *************************************************************/
        ...
        THUMB
//  329 void PIT3_IRQHandler(void)
//  330 {
PIT3_IRQHandler:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//  331 	if(PIT_TFLG(PIT3) == 1)
        LDR.N    R0,??DataTable18_7  ;; 0x4003713c
        LDR      R0,[R0, #+0]
        CMP      R0,#+1
        BNE.N    ??PIT3_IRQHandler_0
//  332 	{
//  333 	  	disable_irq(PIT3_IRQn);
        MOVS     R0,#+71
          CFI FunCall NVIC_DisableIRQ
        BL       NVIC_DisableIRQ
//  334 		//gpio_turn (PTA17);// PTA17 LED 反转
//  335 		
//  336         if(Led_Software_Button!=0)     //0跟随系统  否则可以在程序里面控制亮灭
...
//  339         }
//  340         else
//  341         if(Debug_Button_Led )
        LDR.N    R0,??DataTable18_9
        LDRB     R0,[R0, #+0]
        CMP      R0,#+0
        BEQ.N    ??PIT3_IRQHandler_2
//  342         {
//  343            gpio_turn (PTC2);//LED	反转
        MOVS     R0,#+66
...
??PIT3_IRQHandler_3:
        ...
        BNE.N    ??PIT3_IRQHandler_0
//  357         {
//  358         sprintf(Str_View,"Pic:%3d",123);
        MOVS     R2,#+123
        LDR.N    R1,??DataTable18_12
        LDR.N    R0,??DataTable18_13
          CFI FunCall sprintf
        BL       sprintf
//  359         OLED_P6x8Str(0,2,(u8*)Str_View);
        LDR.N    R2,??DataTable18_13
        MOVS     R1,#+2
        MOVS     R0,#+0
          CFI FunCall OLED_P6x8Str
        BL       OLED_P6x8Str
//  360         sprintf(Str_View,"Time:%2d",Time);
        LDR.N    R0,??DataTable18_10
        LDR      R2,[R0, #+0]
        ...
        LDR.N    R0,??DataTable18_13
          CFI FunCall sprintf
        BL       sprintf
//  361         OLED_P6x8Str(0,3,(u8*)Str_View);
        LDR.N    R2,??DataTable18_13
        MOVS     R1,#+3
        MOVS     R0,#+0
          CFI FunCall OLED_P6x8Str
...
//  363         
//  364 	}
//  365 	PIT_Flag_Clear(PIT3);//清中断标志位	
??PIT3_IRQHandler_0:
        LDR.N    R0,??DataTable18_7  ;; 0x4003713c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x1
...
//  369 /*************************** 以下用作摄像头采集 ****************************/
        ...
        THUMB
//  370 __ramfunc void PORTC_IRQHandler()
//  371 {
PORTC_IRQHandler:
        PUSH     {R3-R5,LR}
          CFI R4 Frame(CFA, -12)
...
//  374     uint32 flag;
//  375     
//  376     while(!PORTC_ISFR);
??PORTC_IRQHandler_0:
        LDR.N    R0,??DataTable6_8  ;; 0x4004b0a0
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BEQ.N    ??PORTC_IRQHandler_0
//  377     flag = PORTC_ISFR;
        LDR.N    R0,??DataTable6_8  ;; 0x4004b0a0
        LDR      R5,[R0, #+0]
//  378     PORTC_ISFR  = ~0;         //清中断标志位
        MOVS     R0,#-1
        LDR.N    R1,??DataTable6_8  ;; 0x4004b0a0
        STR      R0,[R1, #+0]
//  379     
//  380     n = 7;                    //场中断
        MOVS     R4,#+7
//  381     if(flag & (1 << n))       //PTC7触发中断
        MOVS     R0,R5
        LSRS     R0,R0,R4
        LSLS     R0,R0,#+31
...
//  382     {
//  383         camera_vsync();
          CFI FunCall ov7725_eagle_vsync
        BL       ov7725_eagle_vsync
//  384     }
//  385   #if ( CAMERA_USE_HREF == 1 )//使用行中断
//  386     n = 18;//(18)
//  387     if(flag & (1 << n))               //PTA28触发中断
//  388     {
//  389         camera_href();
//  390     }
//  391   #endif
...
//  393     
        ...
        SECTION_TYPE SHT_PROGBITS, SHF_WRITE | SHF_EXECINSTR
          ...
          CFI Function DMA0_IRQHandler
        THUMB
//  394 __ramfunc void DMA0_IRQHandler()
//  395 {
DMA0_IRQHandler:
        PUSH     {R7,LR}
          CFI R14 Frame(CFA, -4)
